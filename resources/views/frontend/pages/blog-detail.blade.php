...
@section('title','MEDCART || Post Detail page')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Post Single Sidebar</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>By Admin</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"></a></span>
                                    </div>
                                ...
                                <div class="single-post">
                                    <div class="content">
                                        ...
                                        <ul class="comment">
                                            ...
                                            <li><i class="fa fa-user" aria-hidden="true"></i>Admin
                                            </li>
                                        </ul>
                                    </div>
                                </div>
