...
@section('title','MEDCART || Registration Page')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Registration Form</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="post" placeholder="" value="{{old('post')}}">
                                        @error('post')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
